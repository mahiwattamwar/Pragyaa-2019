...
import org.maheshpragyaaa.pragyaa2021.notifications.Config;
...
//                }
                Intent reg = new Intent(Intent.ACTION_VIEW, Uri.parse("https://forms.gle/1o75xSCtxhFqEar88"));
                startActivity(reg);
            }
        });
        ...
        findViewById(R.id.schedule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, Shree.class));
            }
        });
...
//                Intent reg = new Intent(Intent.ACTION_VIEW, Uri.parse("https://pragyaa.tech/Event/contactus.html"));
//                startActivity(reg);
            }
        });
